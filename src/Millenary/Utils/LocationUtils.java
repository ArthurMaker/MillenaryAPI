...
public class LocationUtils{
	...
	public static List<Location> getAllBlocksInsideCuboid(Location corner1, Location corner2){
		...
		for(int x = minX; x <= maxX; x++) for(int y = minY; y <= maxY; y++) for(int z = minZ; z <= maxZ; z++) cube.add(new Location(corner1.getWorld(), x, y, z));
		return cube;
	  }
	 ...
	 * Equation for nerds: sqrt[(x1-x2)^2+(y1-y2)^2+(z1-z2)^2]
	 */
